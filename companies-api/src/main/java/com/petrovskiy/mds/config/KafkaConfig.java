...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, TransactionResult> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, TransactionResult> factory = new ConcurrentKafkaListenerContainerFactory<>();
